...
namespace OllamaPilot.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class OptimizeCodeCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private OptimizeCodeCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static OptimizeCodeCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new OptimizeCodeCommand(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            ThreadHelper.JoinableTaskFactory.Run(() => SelectedCodeCommandExecutor.ExecuteAsync(
                this.package,
                OllamaHelper.Instance.GetOptimizeCodeTemplate,
