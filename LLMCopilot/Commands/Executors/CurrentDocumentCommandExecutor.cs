...
namespace OllamaPilot.Commands.Executors
{
    ...
    internal static class CurrentDocumentCommandExecutor
    {
            ...
            AssistantActionCapabilities assistantActions = AssistantActionCapabilities.Discussion)
        {
            ...
            try
            {
                ...
                OllamaEventManager.OnCodeCommandExecuted(request.VisibleMessage, request.Prompt, assistantActions: assistantActions);
            }
            catch (Exception ex)
            {
