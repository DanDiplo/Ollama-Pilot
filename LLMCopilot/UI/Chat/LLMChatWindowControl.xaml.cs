...
using OllamaChat = OllamaPilot.Services.Ollama.Chat;
...
namespace OllamaPilot.UI.Chat
{
    ...
    public partial class LLMChatWindowControl : UserControl, INotifyPropertyChanged
    {
        ...
        {
            OllamaEventManager.CodeCommandExecuted += OnExplainCodeCommandExecuted;
        ...
        {
            while (OllamaEventManager.TryDequeuePendingCodeCommand(out var pendingCommand))
            {
                await SendChatMessageAsync(
