...
namespace OllamaPilot.UI.Chat
{
    /// <summary>
    /// Command handler
    /// </summary>
    internal sealed class LLMChatWindowCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private LLMChatWindowCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static LLMChatWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new LLMChatWindowCommand(package, commandService);
        }
